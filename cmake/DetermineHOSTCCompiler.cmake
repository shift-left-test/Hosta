...
if(NOT CMAKE_HOSTC_COMPILER_WORKS)
  ...
  file(WRITE ${CMAKE_PLATFORM_INFO_DIR}/CMakeHOSTCCompiler.cmake.in
    ...
    "set(CMAKE_HOSTC_COMPILER_ABI \"@CMAKE_HOSTC_COMPILER_ABI@\")\n"
    "set(CMAKE_HOSTC_IMPLICIT_INCLUDE_DIRECTORIES \"@CMAKE_HOSTC_IMPLICIT_INCLUDE_DIRECTORIES@\")\n"
    "set(CMAKE_HOSTC_IMPLICIT_LINK_LIBRARIES \"@CMAKE_HOSTC_IMPLICIT_LINK_LIBRARIES@\")\n"
    "set(CMAKE_HOSTC_IMPLICIT_LINK_DIRECTORIES \"@CMAKE_HOSTC_IMPLICIT_LINK_DIRECTORIES@\")\n"
    "set(CMAKE_HOSTC_IMPLICIT_LINK_FRAMEWORK_DIRECTORIES \"@CMAKE_HOSTC_IMPLICIT_LINK_FRAMEWORK_DIRECTORIES@\")\n"
  )
